    ...
    public class WitchDoctorSoulHarvestJadeHarvesterPlugin : AbstractSkillHandler, ISkillHandler
    {
        ...
        public override void Load(IController hud)
        {
            ...
            CreateCastRule()
                ...
                .IfTrue(ctx =>
                {
                    var monsters = Hud.Game.AliveMonsters.Where(m => ((m.SummonerAcdDynamicId == 0 && m.IsElite) || !m.IsElite) && m.FloorCoordinate.XYDistanceTo(Hud.Game.Me.FloorCoordinate) <= 18);//18码内除幻术以外怪
                    int Count = 0;
