        ...
        public override void Load(IController hud)
        {
            ...
            CreateCastRule()
                ...
                .IfTrue(ctx =>
                {
                    ...
                    int count = hud.Game.Actors.Where(a => a.SummonerAcdDynamicId == ctx.Skill.Player.SummonerId && (a.SnoActor.Sno == (ActorSnoEnum)467053 || a.SnoActor.Sno == (ActorSnoEnum)484304)).Count();
