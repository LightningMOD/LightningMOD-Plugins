namespace Turbo.Plugins.LightningMod
{
    ...
    {
        public static SpecificBuffIsAboutToExpireTest IfSpecificBuffIsAboutToExpire(this AbstractSkillTest parent, ISnoPower snoPower, int iconIndex, int min, int max, bool excludeZero = false)
        {
