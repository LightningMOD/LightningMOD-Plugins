...
namespace Turbo.Plugins.LightningMod
{
    ...
    {
        private IWatch[] Hover = new IWatch[6]; //由OnMouseOver和OnMouseOut处理
        private bool[] HoverRepeat = { false, false, false, false, false, false }; //由OnMouseOver和OnMouseOut处理
        public int HoverPinDelay { get; set; } = 300; //ms
        public int RepeatPinDelay { get; set; } = 0;
        private IWatch[] timer = new IWatch[6];
        private IBrush Brush;
        private IPlayerSkill[] Skill = new IPlayerSkill[6];
        private RectangleF[] Rect = new RectangleF[6];
        private bool[] EnabledSkill = { false, false, false, false, false, false };
        ...
        public void AfterCollect()
        {
            if (Hud.Game.IsLoading
                ...
                || Hud.Game.Me.Powers.BuffIsActive(Hud.Sno.SnoPowers.Crusader_SteedCharge.Sno)
