    ...
    public class BarbarianWarCryPlugin : AbstractSkillHandler, ISkillHandler
	{
        ...
        public override void Load(IController hud)
        {
            ...
            CreateCastRule()
                ...
                .IfTrue(ctx =>
                {
                    return ctx.Skill.Player.GetSetItemCount(786990) < 6 && ctx.Hud.Game.Players.All(p => !p.IsDead && p.HasValidActor && p.CentralXyDistanceToMe <= 100 && !p.Powers.BuffIsActive(Hud.Sno.SnoPowers.Generic_ActorGhostedBuff.Sno)) && hud.Game.ActorQuery.NearestBoss == null;//队友都在100码内且不是灵魂状态,BOSS不在附近时才生效
                }
