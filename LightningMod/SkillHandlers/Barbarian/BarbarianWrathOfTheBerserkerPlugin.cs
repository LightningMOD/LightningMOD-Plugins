    ...
    public class BarbarianWrathOfTheBerserkerPlugin : AbstractSkillHandler, ISkillHandler
    {
        ...
        public override void Load(IController hud)
        {
            ...
            CreateCastRule()
                ...
                /*.IfTrue(ctx => {
                    var buff = ctx.Skill.Player.Powers.GetBuff(Hud.Sno.SnoPowers.Generic_PagesBuffInfiniteCasting.Sno);//获取减耗塔
                    return buff != null && buff.TimeLeftSeconds[0] > 0 && buff.TimeLeftSeconds[0] < 2;//获取减耗塔剩余时间小于2秒
                }
                ).ThenCastElseContinue()//减耗塔即将结束前施放*/
                ...
                .IfTrue(ctx =>
                {
                    ...
                    return (IKset) || (Hud.Game.Me.Powers.UsedPassives.Any(p => p.Sno == Hud.Sno.SnoPowers.Barbarian_Passive_BoonOfBulKathos.Sno) && ctx.Skill.Player.Stats.CooldownReduction >= 0.75) //布尔凯索的恩泽被动 去 CDR高于
