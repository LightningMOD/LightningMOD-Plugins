...
{
    using System.Linq;
    public class CrusaderLawsOfHopePlugin : AbstractSkillHandler, ISkillHandler
	{
        public CrusaderLawsOfHopePlugin()
        ...
        {
            base.Load(hud);
            AssignedSnoPower = Hud.Sno.SnoPowers.Crusader_LawsOfHope;
            ...
            CreateCastRule()
                ...
                .IfSpecificBuffIsActive(Hud.Sno.SnoPowers.Generic_X1CrusaderLawsOfHopePassive2, 6).ThenNoCastElseContinue()//已激活
                .IfTrue(ctx =>
