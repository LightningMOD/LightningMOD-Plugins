    ...
    public class OpenChestPlugin : BasePlugin, IAfterCollectHandler, INewAreaHandler
    {
        ...
        public void AfterCollect()
        {
            ...
            var Actors = Hud.Game.Actors.Where(x =>
            {
                ...
                || (Shrine && (x.SnoActor.Kind == ActorKind.Shrine && x.GizmoType != GizmoType.HealingWell && x.GizmoType != GizmoType.PoolOfReflection && (Hud.Game.Me.InGreaterRiftRank == 0 || (Hud.Game.Me.InGreaterRiftRank <= ClickPylonInGRRank))
                && 
