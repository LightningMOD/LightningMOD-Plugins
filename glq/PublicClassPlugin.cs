...
*/
        ...
        public static bool isMobInSkillRange(IController Hud, IMonster mob, float skillWidth, float skillRange)//skillWidth=技能的范围宽度（三角形底边），skillRange=技能的最大施法距离，三角形的高度
        {
            IWorldCoordinate A = Hud.Game.Me.FloorCoordinate;
            IWorldCoordinate B = Hud.Window.CreateScreenCoordinate(Hud.Window.CursorX, Hud.Window.CursorY).ToWorldCoordinate();
